...
begin
  ShowCollectionEditor(Designer, Component, TChromeTabs32(Component).Tabs, 'Tabs');
end;
...
begin
  ChromeTabs32 := TChromeTabs32(GetComponent);
      ...
      begin
        ...
        try
          ...
          if OpenDialog.Execute then
            case Index of
              0: ChromeTabs32.LoadLookAndFeel(OpenDialog.FileName);
              3: ChromeTabs32.LoadOptions(OpenDialog.FileName);
            end;
        finally
      ...
      begin
        ...
        try
          ...
          if SaveDialog.Execute then
            case Index of
              1: ChromeTabs32.SaveLookAndFeel(SaveDialog.FileName);
              4: ChromeTabs32.SaveOptions(SaveDialog.FileName);
            end;
        finally
          FreeAndNil(OpenDialog);
        end;
