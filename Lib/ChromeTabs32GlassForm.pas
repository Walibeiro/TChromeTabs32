...
type
  ...
  TChromeTabs32GlassForm = class(TForm)
  private
    ...
    FChromeTabs32WindowedTopOffset: Integer;
    FChromeTabs32MaxmizedTopOffset: Integer;
    FChromeTabs32MaximizedRightOffset: Integer;
    FChromeTabs32WindowedRightOffset: Integer;
    FAeroEnabled: Boolean;
    FPreviousGlassFrameEnabled: Boolean;
    FPreviousChromeTabs32Top: Integer;
    FPreviousChromeTabs32Left: Integer;
    FPreviousChromeTabs32Width: Integer;
    FPreviousChromeTabs32Align: TAlign;
    FPreviousChromeTabs32Height: Integer;
    FPreviousChromeTabs32TopOffset: Integer;
    FTabsInTitleBar: Boolean;

    procedure RecalcGlassFrameBounds(UpdateFrame: Boolean = TRUE);
    procedure SetChromeTabs32(const Value: TChromeTabs32);
    procedure UpdateChromeTabPosition;
    procedure SetChromeTabs32MaximizedRightOffset(const Value: Integer);
    procedure SetChromeTabs32MaxmizedTopOffset(const Value: Integer);
    procedure SetChromeTabs32WindowedRightOffset(const Value: Integer);
    procedure SetChromeTabs32WindowedTopOffset(const Value: Integer);
  ...
  public
    ...
    property ChromeTabs32: TChromeTabs32 read FChromeTabs32 write SetChromeTabs32;
    property ChromeTabs32WindowedTopOffset: Integer read FChromeTabs32WindowedTopOffset write SetChromeTabs32WindowedTopOffset;
    property ChromeTabs32MaxmizedTopOffset: Integer read FChromeTabs32MaxmizedTopOffset write SetChromeTabs32MaxmizedTopOffset;
    property ChromeTabs32MaximizedRightOffset: Integer read FChromeTabs32MaximizedRightOffset write SetChromeTabs32MaximizedRightOffset;
    property ChromeTabs32WindowedRightOffset: Integer read FChromeTabs32WindowedRightOffset write SetChromeTabs32WindowedRightOffset;
...
procedure TChromeTabs32GlassForm.AdjustClientRect(var Rect: TRect);
begin
  inherited;
...
procedure TChromeTabs32GlassForm.PaintWindow(DC: HDC);
var
  R: TRect;
begin
...
procedure TChromeTabs32GlassForm.UpdateAeroEnabled;
var
  AeroEnabled: Bool;
begin
  FAeroEnabled := FALSE;
...
procedure TChromeTabs32GlassForm.RecalcGlassFrameBounds(UpdateFrame: Boolean);
var
  R: TRect;
begin
  SetRectEmpty(R);
...
procedure TChromeTabs32GlassForm.Resize;
begin
  if ShowTabsInTitleBar then
  begin
    ...
    FChromeTabs32.InvalidateAllControls;
  end;

  inherited;
end;

procedure TChromeTabs32GlassForm.WMNCCalcSize(var Message: TWMNCCalcSize);
begin
  if ShowTabsInTitleBar then
  begin
...
procedure TChromeTabs32GlassForm.WMNCHitTest(var Message: TWMNCHitTest);
var
  ClientPos: TPoint;
  IconRect: TRect;
begin
...
procedure TChromeTabs32GlassForm.WMNCRButtonUp(var Message: TWMNCRButtonUp);
begin
...
procedure TChromeTabs32GlassForm.WMDWMCompositionChanged(var Msg: TMessage);
var
...
procedure TChromeTabs32GlassForm.DisableTitleTabs;
begin
  if (FChromeTabs32 <> nil) and (FTabsInTitleBar) then
  begin
    GlassFrame.Enabled := FPreviousGlassFrameEnabled;
    FChromeTabs32.Options.Display.Tabs.OffsetTop := FPreviousChromeTabs32TopOffset;
    FChromeTabs32.Height := FPreviousChromeTabs32Height;
    FChromeTabs32.Top := FPreviousChromeTabs32Top;
    FChromeTabs32.Left := FPreviousChromeTabs32Left;
    FChromeTabs32.Width := FPreviousChromeTabs32Width;
    FChromeTabs32.Align := FPreviousChromeTabs32Align;

    FTabsInTitleBar := FALSE;
  end;
end;

procedure TChromeTabs32GlassForm.DoOnAeroStatusChanged(AeroEnabled: Boolean);
begin
  if Assigned(FOnAeroStatusChanged) then
    FOnAeroStatusChanged(Self, AeroEnabled);
end;

procedure TChromeTabs32GlassForm.EnableTitleTabs;
begin
  if ShowTabsInTitleBar then
  begin
    FTabsInTitleBar := TRUE;
    FPreviousGlassFrameEnabled := GlassFrame.Enabled;
    FPreviousChromeTabs32Top := FChromeTabs32.Top;
    FPreviousChromeTabs32Left := FChromeTabs32.Left;
    FPreviousChromeTabs32Width := FChromeTabs32.Width;
    FPreviousChromeTabs32Align := FChromeTabs32.Align;
    FPreviousChromeTabs32TopOffset := FChromeTabs32.Options.Display.Tabs.OffsetTop;
    FPreviousChromeTabs32Height := FChromeTabs32.Height;

    FChromeTabs32.Height := FChromeTabs32.Height - FChromeTabs32.Options.Display.Tabs.OffsetTop;
    FChromeTabs32.Options.Display.Tabs.OffsetTop := 0;

    FChromeTabs32.Align := alNone;
...
procedure TChromeTabs32GlassForm.WMWindowPosChanging(var Message: TWMWindowPosChanging);
const
...
procedure TChromeTabs32GlassForm.WMWindowPosChanged(var Message: TWMWindowPosChanged);
begin
  inherited;
...
procedure TChromeTabs32GlassForm.WndProc(var Message: TMessage);
begin
  if (not ShowTabsInTitleBar) or
...
procedure TChromeTabs32GlassForm.SetChromeTabs32(const Value: TChromeTabs32);
begin
  if (not (csDestroying in ComponentState)) and (Value <> FChromeTabs32) then
  begin
    if FChromeTabs32 <> nil then
      DisableTitleTabs;
...
procedure TChromeTabs32GlassForm.SetChromeTabs32MaximizedRightOffset(
  const Value: Integer);
begin
  FChromeTabs32MaximizedRightOffset := Value;

  Invalidate;
end;

procedure TChromeTabs32GlassForm.SetChromeTabs32MaxmizedTopOffset(
  const Value: Integer);
begin
  FChromeTabs32MaxmizedTopOffset := Value;

  Invalidate;
end;

procedure TChromeTabs32GlassForm.SetChromeTabs32WindowedRightOffset(
  const Value: Integer);
begin
  FChromeTabs32WindowedRightOffset := Value;

  Invalidate;
end;

procedure TChromeTabs32GlassForm.SetChromeTabs32WindowedTopOffset(
  const Value: Integer);
begin
  FChromeTabs32WindowedTopOffset := Value;

  Invalidate;
end;

procedure TChromeTabs32GlassForm.ThemeChanged;
begin
  // override if you need to do anything when the theme is changed
end;

procedure TChromeTabs32GlassForm.UpdateChromeTabPosition;
var
...
begin
  ...
  begin
    if WindowState = wsMaximized then
    begin
      TopOffset := FChromeTabs32MaxmizedTopOffset;
      RightOffset := FChromeTabs32MaximizedRightOffset
    end
    else
    begin
      TopOffset := FChromeTabs32WindowedTopOffset;
      RightOffset := FChromeTabs32WindowedRightOffset;
    end;

    GlassFrame.Top := FChromeTabs32.Height + TopOffset;

    FChromeTabs32.Top := TopOffset;
    FChromeTabs32.Left := 0;
    FChromeTabs32.Width := Width - (FDwmBorderIconsRect.Right - FDwmBorderIconsRect.Left) - RightOffset;

    RecalcGlassFrameBounds(FALSE);
  end;
end;

function TChromeTabs32GlassForm.ShowTabsInTitleBar: Boolean;
begin
  Result := (FChromeTabs32 <> nil) and
            (FAeroEnabled);
end;

constructor TChromeTabs32GlassForm.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);

  // Set the defaults
  FChromeTabs32WindowedTopOffset := 16;
  FChromeTabs32MaxmizedTopOffset := 8;
  FChromeTabs32WindowedRightOffset := 20;
  FChromeTabs32MaximizedRightOffset := 35;

  UpdateAeroEnabled;
end;

procedure TChromeTabs32GlassForm.Notification(AComponent: TComponent;
...
begin
  ...
  begin
    if AComponent = FChromeTabs32 then
      SetChromeTabs32(nil);
  end;
end;
