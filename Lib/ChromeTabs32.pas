...
// Version 2.3
//
// TChromeTabs32 - A Chome Tab component for Delphi 6-XE8 that includes ALL the
...
uses
  ...
  GR32, GR32_Paths, GR32_Brushes,

  ChromeTabs32Types,
  ChromeTabs32Utils,
  ChromeTabs32Controls,
  ChromeTabs32ThreadTimer,
  ChromeTabs32Classes;

type
  TCustomChromeTabs32 = class;
  ...
  TOnStateChange = procedure(Sender: TObject; PreviousState: TChromeTabs32tates; CurrentState: TChromeTabs32tates) of object;
  TOnBeforeDrawItem = procedure(Sender: TObject; TargetCanvas: TCanvas32; ItemRect: TRect; ItemType: TChromeTabItemType; TabIndex: Integer; var Handled: Boolean) of object;
  TOnAfterDrawItem = procedure(Sender: TObject; const TargetCanvas: TCanvas32; ItemRect: TRect; ItemType: TChromeTabItemType; TabIndex: Integer) of object;
  TOnGetControlPolygons = procedure(Sender: TObject; ChromeTabs32Control: TObject; ItemRect: TRect; ItemType: TChromeTabItemType; Orientation: TTabOrientation; var Polygons: IChromeTabPolygons) of object;
  ...
  TOnAnimateStyle = procedure(Sender: TObject; ChromeTabs32Control: TBaseChromeTabs32Control; NewDrawState: TDrawState; var AnimationTimeMS: Cardinal; var EaseType: TChromeTabs32EaseType) of object;
  TOnAnimateMovement = procedure(Sender: TObject; ChromeTabs32Control: TBaseChromeTabs32Control; var AnimationTimeMS: Cardinal; var EaseType: TChromeTabs32EaseType) of object;
  ...
  private
    ...
    FRange: Integer;
    FStep: Integer;
    FChromeTabs32: TCustomChromeTabs32;
  public
  ...
  TCustomChromeTabs32 = class(TCustomControl, IChromeTabs32, IChromeTabDockControl)
  private
    // IChromeTabInterface
  ...
  private
    ...
    FOptions: TOptions;
    FLookAndFeel: TChromeTabs32LookAndFeel;
    ...
    FMovementEaseType: TChromeTabs32EaseType;
    ...
    function FindChromeTabs32ControlWithinRange(Pt: TPoint; Range: Integer; Step: Integer = 5): TCustomChromeTabs32;
    ...
    procedure SetControlDrawState(ChromeTabs32Control: TBaseChromeTabs32Control; NewDrawState: TDrawState; ForceUpdate: Boolean = FALSE);
    ...
    procedure SetControlPosition(ChromeTabs32Control: TBaseChromeTabs32Control; ControlRect: TRect; Animate: Boolean);
    procedure SetControlLeft(ChromeTabs32Control: TBaseChromeTabs32Control; ALeft: Integer; Animate: Boolean);
    procedure SetMovementAnimation(MovementAnimationTypes: TChromeTabs32MovementAnimationTypes);
  ...
  protected
    ...
    procedure DoOnStateChange(PreviousState: TChromeTabs32tates; CurrentState: TChromeTabs32tates); virtual;
    ...
    procedure DoOnAnimateStyle(ChromeTabs32Control: TBaseChromeTabs32Control; NewDrawState: TDrawState; var AnimationTimeMS: Cardinal; var EaseType: TChromeTabs32EaseType); virtual;
    procedure DoOnAnimateMovement(ChromeTabs32Control: TBaseChromeTabs32Control; var AnimationTimeMS: Cardinal; var EaseType: TChromeTabs32EaseType); virtual;
    ...
    // Virtual (IChromeTabs32)
    procedure DoOnBeforeDrawItem(TargetCanvas: TCanvas32; ItemRect: TRect; ItemType: TChromeTabItemType; TabIndex: Integer; var Handled: Boolean); virtual;
    procedure DoOnAfterDrawItem(const TargetCanvas: TCanvas32; ItemRect: TRect; ItemType: TChromeTabItemType; TabIndex: Integer); virtual;
    procedure DoOnGetControlPolygons(ChromeTabs32Control: TObject; ItemRect: TRect; ItemType: TChromeTabItemType; Orientation: TTabOrientation; var Polygons: IChromeTabPolygons); virtual;
    ...
    function AddState(State: TChromeTabs32tate): Boolean; virtual;
    function RemoveState(State: TChromeTabs32tate): Boolean; virtual;
  protected
    ...
    property LookAndFeel: TChromeTabs32LookAndFeel read GetLookAndFeel write SetLookAndFeel;
    ...
    property Tabs: TChromeTabs32List read FTabs write SetTabs;
  public
    ...
    function HasState(State: TChromeTabs32tate): Boolean; virtual;
    ...
    property State: TChromeTabs32tates read FState;
  ...
  TChromeTabs32 = class(TCustomChromeTabs32)
  published
...
const
  ...
  DefaultCodeComponentName = 'ChromeTabs321';
...
function TCustomChromeTabs32.FindChromeTabs32ControlWithinRange(Pt: TPoint; Range: Integer; Step: Integer): TCustomChromeTabs32;
var
...
begin
  ...
  try
    ...
    Result := WindowFromPointFixThread.FChromeTabs32;
  finally
    FreeAndNil(WindowFromPointFixThread);
  end;
end;

function TCustomChromeTabs32.GetPinnedTabCount: Integer;
begin
  Result := GetLastPinnedTabIndex + 1;
end;

function TCustomChromeTabs32.GetPreviousTabPolygons(
...
function TCustomChromeTabs32.GetVisiblePinnedTabCount(IncludeMarkedForDelete: Boolean): Integer;
var
  i: Integer;
begin
  Result := 0;
...
function TCustomChromeTabs32.GetVisibleTabCount(IncludeMarkedForDelete: Boolean): Integer;
begin
  Result := GetVisiblePinnedTabCount(IncludeMarkedForDelete) + GetVisibleNonPinnedTabCount(IncludeMarkedForDelete);
end;

function TCustomChromeTabs32.GetVisibleNonPinnedTabCount(IncludeMarkedForDelete: Boolean): Integer;
var
  i: Integer;
begin
  Result := 0;
...
procedure TCustomChromeTabs32.BeginDrag(MouseX, MouseY: Integer);
var
...
begin
  ...
  HitTestResult := HitTest(GR32.Point(MouseX, MouseY));
  ...
  begin
    ...
    begin
      ...
      FDragTabObject.DragCursorOffset := GR32.Point(
        MouseX - BidiXPos(TabControls[HitTestResult.TabIndex].ControlRect.Left) + BidiScrollOffset,
...
procedure TCustomChromeTabs32.BeginUpdate;
begin
...
procedure TCustomChromeTabs32.CMMouseEnter(var Msg: TMessage);
begin
...
procedure TCustomChromeTabs32.CMMouseLeave(var Msg: TMessage);
begin
  FLastMouseX := -1;
  FLastMouseY := -1;
...
function TCustomChromeTabs32.GetTabDisplayState: TTabDisplayState;
begin
...
procedure TCustomChromeTabs32.ClearTabClosingStates;
begin
...
procedure TCustomChromeTabs32.DoOnMouseLeave;
begin
...
function TCustomChromeTabs32.InsertDroppedTab: TChromeTab;
begin
  Result := nil;
...
function TCustomChromeTabs32.AddState(State: TChromeTabs32tate): Boolean;
var
  PreviousState: TChromeTabs32tates;
begin
...
procedure TCustomChromeTabs32.AfterConstruction;
begin
  inherited;
...
function TCustomChromeTabs32.RemoveState(State: TChromeTabs32tate): Boolean;
var
  PreviousState: TChromeTabs32tates;
begin
...
function TCustomChromeTabs32.HasState(State: TChromeTabs32tate): Boolean;
begin
  Result := State in FState;
end;

procedure TCustomChromeTabs32.DoOnAnimateMovement(
...
begin
  if Assigned(FOnAnimateMovement) then
    FOnAnimateMovement(Self, ChromeTabs32Control, AnimationTimeMS, EaseType);
end;

procedure TCustomChromeTabs32.DoOnAnimateStyle(ChromeTabs32Control: TBaseChromeTabs32Control; NewDrawState: TDrawState; var AnimationTimeMS: Cardinal; var EaseType: TChromeTabs32EaseType);
begin
  if Assigned(FOnAnimateStyle) then
    FOnAnimateStyle(Self, ChromeTabs32Control, NewDrawState, AnimationTimeMS, EaseType);
end;

procedure TCustomChromeTabs32.SetControlDrawState(ChromeTabs32Control: TBaseChromeTabs32Control; NewDrawState: TDrawState; ForceUpdate: Boolean);
var
  AnimationTimeMS: Cardinal;
  EaseType: TChromeTabs32EaseType;
begin
  if (ChromeTabs32Control.DrawState <> NewDrawState) or (ForceUpdate) then
  begin
    if (not (csDesigning in ComponentState)) and
       (((ChromeTabs32Control.DrawState = dsHot) and ((NewDrawState <> dsActive)) or (not (ChromeTabs32Control is TChromeTabControl))) or
        ((NewDrawState = dsHot) and (ChromeTabs32Control.DrawState <> dsActive)) or (not (ChromeTabs32Control is TChromeTabControl))) then
    ...
    if (ChromeTabs32Control.DrawState <> NewDrawState) and (not (csDesigning in ComponentState)) then
      DoOnAnimateStyle(ChromeTabs32Control, NewDrawState, AnimationTimeMS, EaseType);

    ChromeTabs32Control.SetDrawState(NewDrawState, AnimationTimeMS, EaseType, ForceUpdate);
  end;
end;

procedure TCustomChromeTabs32.SetControlDrawStates(ForceUpdate: Boolean);
var
  i: Integer;
  HitTestResult: THitTestResult;
begin
  ...
  begin
    BeginUpdate;
    try
      HitTestResult := HitTest(GR32.Point(FLastMouseX, FLastMouseY), FALSE);
...
procedure TCustomChromeTabs32.SetImages(const Value: TCustomImageList);
begin
  FImages := Value;
...
procedure TCustomChromeTabs32.SetOptions(const Value: TOptions);
begin
  FOptions.Assign(Value);
end;

procedure TCustomChromeTabs32.SetScrollOffset(const Value: Integer);
begin
  SetScrollOffsetEx(Value, FALSE);
end;

function TCustomChromeTabs32.GetMaxScrollOffset: Integer;
begin
...
procedure TCustomChromeTabs32.SetScrollOffsetEx(const Value: Integer; IgnoreContraints: Boolean);
begin
...
procedure TCustomChromeTabs32.SetImagesOverlay(const Value: TCustomImageList);
begin
...
procedure TCustomChromeTabs32.SetImagesSpinnerDownload(
  const Value: TCustomImageList);
begin
  FImagesSpinnerDownload := Value;
end;

procedure TCustomChromeTabs32.SetImagesSpinnerUpload(
  const Value: TCustomImageList);
begin
  FImagesSpinnerUpload := Value;
end;

procedure TCustomChromeTabs32.DeleteTab(Index: Integer);
begin
  FTabs.DeleteTab(Index, csDesigning in ComponentState);
end;

procedure TCustomChromeTabs32.DoPopupClick(Sender: TObject);
var
  OperationID: Integer;
begin
...
procedure TCustomChromeTabs32.EndDrag(MouseX, MouseY: Integer; Cancelled: Boolean);
var
  DummyAccept: Boolean;
  NewTab: TChromeTab;
...
procedure TCustomChromeTabs32.DoOnTabDragEnd(MouseX, MouseY: Integer; Cancelled: Boolean);
begin
  if Assigned(FOnTabDragEnd) then
    FOnTabDragEnd(Self, MouseX, MouseY, Cancelled);
end;

procedure TCustomChromeTabs32.EndUpdate;
begin
  if FUpdateCount > 0 then
  begin
    Dec(FUpdateCount);
...
function TCustomChromeTabs32.DragTabInTabRect(MouseX, MouseY: Integer): Boolean;
var
  DragRect: TRect;
begin
  Result := TRUE;
  ...
  begin
    ...
    Result := PtInRect(DragRect, GR32.Point(MouseX, MouseY));
  end;
end;

function TCustomChromeTabs32.GetLastVisibleTabIndex(StartIndex: Integer): Integer;
var
  i: Integer;
begin
  Result := -1;
...
function TCustomChromeTabs32.ControlReady: Boolean;
begin
...
procedure TCustomChromeTabs32.DoOnChange(ATab: TChromeTab; TabChangeType: TTabChangeType);
var
  i: Integer;
...
procedure TCustomChromeTabs32.UpdateProperties;
begin
  if ControlReady then
  begin
...
procedure TCustomChromeTabs32.WMMouseWheel(var Msg: TWMMouseWheel);
begin
...
procedure TCustomChromeTabs32.DoOnActiveTabChanged(ATab: TChromeTab);
begin
  if Assigned(FOnActiveTabChanged) then
    FOnActiveTabChanged(Self, ATab);
end;

procedure TCustomChromeTabs32.DoOnActiveTabChanging(AOldTab, ANewTab: TChromeTab;
  var Allow: Boolean);
begin
...
procedure TCustomChromeTabs32.DoPopup(Sender: TObject; APoint: TPoint);
var
  i: Integer;
  AMenuItem: TMenuItem;
...
begin
  ...
  HitTestResult := HitTest(GR32.Point(FLastMouseX, FLastMouseY));
...
procedure TCustomChromeTabs32.DoOnTabMenuPopup(const ATab: TChromeTab; const PopupMenu: TPopupMenu);
begin
  if Assigned(FOnTabPopupMenu) then
    FOnTabPopupMenu(Self, ATab, PopupMenu);
end;

constructor TCustomChromeTabs32.Create(AOwner: TComponent);
begin
  inherited;
  ...
  // Options
  FLookAndFeel := TChromeTabs32LookAndFeel.Create(Self);
  FOptions := TOptions.Create(Self);

  FTabs := TChromeTabs32List.Create(Self);
...
procedure TCustomChromeTabs32.OnCancelTabSmartResizeTimer(Sender: TObject);
begin
  FCancelTabSmartResizeTimer.Enabled := FALSE;
...
procedure TCustomChromeTabs32.OnScrollTimerTimer(Sender: TObject);
begin
  if GetTabDisplayState = tdScrolling then
    ScrollTabs(FScrollDirection);
end;

function TCustomChromeTabs32.OptionsToCode: String;
var
...
procedure TCustomChromeTabs32.FireScrollTimer;
begin
  OnScrollTimerTimer(FScrollTimer);
end;

procedure TCustomChromeTabs32.ScrollTabs(ScrollDirection: TScrollDirection; StartTimer: Boolean);
var
  IncValue: Integer;
begin
  if GetTabDisplayState = tdScrolling then
...
procedure TCustomChromeTabs32.OnAnimateTimer(Sender: TObject);
...
destructor TCustomChromeTabs32.Destroy;
begin
  FreeAndNil(FTabs);
...
function TCustomChromeTabs32.GetActiveTab: TChromeTab;
begin
  Result := Tabs.ActiveTab;
end;

function TCustomChromeTabs32.GetActiveTabIndex: Integer;
begin
...
function TCustomChromeTabs32.GetBiDiMode: TBiDiMode;
begin
  Result := BiDiMode;
end;

function TCustomChromeTabs32.GetBidiScrollOffset: Integer;
begin
...
function TCustomChromeTabs32.GetComponentState: TComponentState;
begin
  Result := ComponentState;
end;

function TCustomChromeTabs32.GetControl: TWinControl;
begin
  Result := Self;
end;

function TCustomChromeTabs32.GetImages: TCustomImageList;
begin
  Result := FImages;
end;

function TCustomChromeTabs32.GetLastPinnedIndex: Integer;
begin
  Result := GetLastPinnedTabIndex;
end;

function TCustomChromeTabs32.GetLastPinnedTabIndex: Integer;
begin
...
function TCustomChromeTabs32.GetTabControl(Index: Integer): TChromeTabControl;
begin
  if Index = -1 then
    Result := nil
  else
...
function TCustomChromeTabs32.GetTabDescription(Index: Integer): String;
begin
  if (Index >= 0) and
...
function TCustomChromeTabs32.GetTabUnderMouse: TChromeTab;
var
  HitTestResult: THitTestResult;
begin
  HitTestResult := HitTest(GR32.Point(FLastMouseX, FLastMouseY));
...
function TCustomChromeTabs32.HitTest(pt: TPoint; IgnoreDisabledControls: Boolean): THitTestResult;
var
...
procedure TCustomChromeTabs32.MouseDown(Button: TMouseButton; Shift: TShiftState; x, y: Integer);
begin
  inherited;

  if not HasState(stsMouseDown) then
  begin
    FMouseDownHitTest := HitTest(GR32.Point(x, y));
    FMouseButton := Button;
...
procedure TCustomChromeTabs32.CMHintShow(var Message: TCMHintShow);
var
  HitTestResult: THitTestResult;
  HintText: String;
  HintTimeout: Integer;
...
function TCustomChromeTabs32.BidiRect(ARect: TRect): TRect;
begin
  if BiDiMode in BidiRightToLeftTabModes then
...
function TCustomChromeTabs32.BidiXPos(X: Integer): Integer;
begin
  if BiDiMode in BidiRightToLeftTabModes then
...
procedure TCustomChromeTabs32.MouseMove(Shift: TShiftState; x, y: Integer);
var
  HitTestResult: THitTestResult;
  AllowDrag: Boolean;
...
begin
  ...
  begin
    ...
    BeginUpdate;
    try
      HitTestResult := HitTest(GR32.Point(X, Y));
      ...
      begin
        ...
        begin
          ...
          CursorWinControl := FindChromeTabs32ControlWithinRange(ScreenPoint, FOptions.DragDrop.DragOutsideDistancePixels);

          Accept := FALSE;

          if CursorWinControl = nil then
            DoOnDebugLog('No ChromeTabs32 found at X: %d, Y: %d', [ScreenPoint.X, ScreenPoint.Y])
          else
            DoOnDebugLog('ChromeTabs32 (%s) found at X: %d, Y: %d', [CursorWinControl.Name, ScreenPoint.X, ScreenPoint.Y]);
...
function TCustomChromeTabs32.CreateDragForm(ATab: TChromeTab): TForm;
const
  TransparentColor = clWhite - $100;
var
  DragControl: TWinControl;
  DragCanvas: TCanvas32;
  ...
  begin
    ...
    begin
      ...
      if ActualDragDisplay = ddTab then
        FDragTabObject.DragFormOffset := GR32.Point(BiDiX, FDragTabObject.DragCursorOffset.Y)
      else
        FDragTabObject.DragFormOffset := GR32.Point(Round(BiDiX * FOptions.DragDrop.DragControlImageResizeFactor),
            ...
            case FOptions.Display.Tabs.Orientation of
              ...
              toBottom:
                begin
                  ...
                  FDragTabObject.DragFormOffset := GR32.Point(
                    FDragTabObject.DragFormOffset.X,
...
(* TODO
        DragCanvas := TCanvas32.Create(Bitmap.Canvas.Handle);
        try
...
// TODO          BitmapToBitmap32(ScaledBitmap);
...
procedure TCustomChromeTabs32.CreateWindowHandle(const Params: TCreateParams);
begin
  inherited;
...
procedure TCustomChromeTabs32.DoOnButtonAddClick;
var
  Handled: Boolean;
begin
  Handled := FALSE;
...
procedure TCustomChromeTabs32.DoOnCreateDragForm(ATab: TChromeTab;
  var DragForm: TForm);
begin
...
procedure TCustomChromeTabs32.DoOnDebugLog(const Text: String; Args: Array of const);
begin
  if (FOptions.Behaviour.DebugMode) and (Assigned(FOnDebugLog)) then
    FOnDebugLog(Self, format(Text, Args));
end;

procedure TCustomChromeTabs32.DoOnGetControlPolygons(ChromeTabs32Control: TObject; ItemRect: TRect;
...
begin
  if Assigned(FOnGetControlPolygons) then
    FOnGetControlPolygons(Self, ChromeTabs32Control, ItemRect, ItemType, Orientation, Polygons);
end;

procedure TCustomChromeTabs32.DoOnNeedDragImageControl(ATab: TChromeTab;
...
procedure TCustomChromeTabs32.DoOnScroll;
begin
  if Assigned(FOnScroll) then
    FOnScroll(Self);
end;

procedure TCustomChromeTabs32.DoOnShowHint(HitTestResult: THitTestResult;
...
procedure TCustomChromeTabs32.DoOnStateChange(PreviousState,
...
procedure TCustomChromeTabs32.DoOnScrollWidthChanged;
begin
  if Assigned(FOnScrollWidthChanged) then
    FOnScrollWidthChanged(Self);
end;

procedure TCustomChromeTabs32.DoOnSetTabWidth(ATabControl: TChromeTabControl;
...
procedure TCustomChromeTabs32.DoOnTabDblClick(ATab: TChromeTab);
begin
  if Assigned(FOnTabDblClick) then
    FOnTabDblClick(Self, ATab);
end;

procedure TCustomChromeTabs32.DoOnTabDragDrop(X, Y: Integer; DragTabObject: IDragTabObject; Cancelled: Boolean;
...
procedure TCustomChromeTabs32.DoOnTabDragDropped(DragTabObject: IDragTabObject;
  NewTab: TChromeTab);
begin
...
procedure TCustomChromeTabs32.DoOnTabDragOver(X, Y: Integer; State: TDragState;
...
procedure TCustomChromeTabs32.DoOnTabDragStart(ATab: TChromeTab;
  var Allow: Boolean);
begin
...
procedure TCustomChromeTabs32.MouseUp(Button: TMouseButton; Shift: TShiftState; x, y: Integer);
var
  AllowClose: Boolean;
  HitTestResult: THitTestResult;
begin
...
procedure TCustomChromeTabs32.DoOnAfterDragImageCreated;
begin
  if Assigned(FOnAfterDragImageCreated) then
    FOnAfterDragImageCreated(Self);
end;

procedure TCustomChromeTabs32.DoOnAfterDrawItem(const TargetCanvas: TCanvas32;
...
procedure TCustomChromeTabs32.DoOnBeforeDrawItem(TargetCanvas: TCanvas32;
  ItemRect: TRect; ItemType: TChromeTabItemType; TabIndex: Integer;
  var Handled: Boolean);
begin
  Handled := FALSE;
...
procedure TCustomChromeTabs32.DoOnBeginTabDrag(ATab: TChromeTab;
  var Allow: Boolean);
begin
...
procedure TCustomChromeTabs32.DoOnButtonCloseTabClick(ATab: TChromeTab; var AllowClose: Boolean);
begin
  if Assigned(FOnButtonCloseTabClick) then
    FOnButtonCloseTabClick(Self, ATab, AllowClose);
end;

procedure TCustomChromeTabs32.Notification(AComponent: TComponent;
...
procedure TCustomChromeTabs32.WMLButtonDblClk(var Message: TWMLButtonDblClk);
var
  HitTestResult: THitTestResult;
...
begin
  ...
  begin
    HitTestResult := HitTest(GR32.Point(Message.XPos, Message.YPos));
...
procedure TCustomChromeTabs32.SaveLookAndFeel(Stream: TStream);
var
...
procedure TCustomChromeTabs32.SaveLookAndFeel(const Filename: String);
var
...
procedure TCustomChromeTabs32.SaveOptions(const Filename: String);
var
  FileStream: TFileStream;
begin
  if FileExists(Filename) then
...
procedure TCustomChromeTabs32.SaveOptions(Stream: TStream);
var
  TabsOptions: TTabsOptions;
begin
  TabsOptions := TTabsOptions.Create(nil);
...
function TCustomChromeTabs32.ScrollButtonLeftVisible: Boolean;
begin
  Result := ((ScrollingActive) or (not FOptions.Scrolling.AutoHideButtons)) and
            (FOptions.Scrolling.Enabled);
end;

function TCustomChromeTabs32.ScrollButtonRightVisible: Boolean;
begin
  Result := ((ScrollingActive) or (not FOptions.Scrolling.AutoHideButtons)) and
            (FOptions.Scrolling.Enabled);
end;

procedure TCustomChromeTabs32.CalculateButtonRects;
var
...
function TCustomChromeTabs32.ScrollingActive: Boolean;
begin
  Result := FScrollWidth - FTabEndSpace > CorrectedClientWidth
end;

function TCustomChromeTabs32.SameBidiTabMode(BidiMode1, BiDiMode2: TBidiMode): Boolean;
begin
...
procedure TCustomChromeTabs32.SetControlPosition(ChromeTabs32Control: TBaseChromeTabs32Control; ControlRect: TRect; Animate: Boolean);
var
  EaseType: TChromeTabs32EaseType;
...
begin
  ...
  if not (csDesigning in ComponentState) then
    DoOnAnimateMovement(ChromeTabs32Control, AnimationTime, EaseType);

  ChromeTabs32Control.SetPosition(ControlRect,
                                AnimationTime,
                                EaseType);
end;

procedure TCustomChromeTabs32.SetControlLeft(ChromeTabs32Control: TBaseChromeTabs32Control; ALeft: Integer; Animate: Boolean);
begin
  SetControlPosition(ChromeTabs32Control,
                     Rect(ALeft,
                          ChromeTabs32Control.ControlRect.Top,
                          RectWidth(ChromeTabs32Control.ControlRect) + ALeft,
                          ChromeTabs32Control.ControlRect.Bottom),
                     Animate);
end;

procedure TCustomChromeTabs32.SetMovementAnimation(MovementAnimationTypes: TChromeTabs32MovementAnimationTypes);
begin
...
function TCustomChromeTabs32.GetTabWidthByContent(TabControl: TChromeTabControl): Integer;
begin
...
procedure TCustomChromeTabs32.CalculateTabRects;
...
function TCustomChromeTabs32.GetOptions: TOptions;
begin
  Result := FOptions;
end;

function TCustomChromeTabs32.GetImagesOverlay: TCustomImageList;
begin
  Result := FImagesOverlay;
end;

function TCustomChromeTabs32.GetImagesSpinnerDownload: TCustomImageList;
begin
  Result := FImagesSpinnerDownload;
end;

function TCustomChromeTabs32.GetImagesSpinnerUpload: TCustomImageList;
begin
  Result := FImagesSpinnerUpload;
end;

procedure TCustomChromeTabs32.PaintWindow(DC: HDC);
begin
  Canvas.Lock;
  try
    Canvas.Handle := DC;
...
function TCustomChromeTabs32.CorrectedClientWidth: Integer;
begin
  Result := Width;
end;

procedure TCustomChromeTabs32.CorrectScrollOffset(AlwaysCorrect: Boolean);
var
...
procedure TCustomChromeTabs32.Resize;
begin
  inherited;
...
procedure TCustomChromeTabs32.Invalidate;
begin
//  AddState(stsControlPositionsInvalidated);
...
procedure TCustomChromeTabs32.InvalidateAllControls;
var
  i: Integer;
begin
  if (ControlReady) and
...
function TCustomChromeTabs32.IsDragging: Boolean;
begin
  Result := FActiveDragTabObject <> nil;
end;

function TCustomChromeTabs32.IsValidTabIndex(Index: Integer): Boolean;
begin
  Result := (Index >= -1) and (Index < FTabs.Count);
end;

procedure TCustomChromeTabs32.LoadLookAndFeel(Stream: TStream);
var
  TabsLookAndFeel: TTabsLookAndFeel;
begin
  BeginUpdate;
...
procedure TCustomChromeTabs32.Loaded;
begin
  inherited;
  ...
  if ActiveTab <> nil then
  begin
    TabControls[ActiveTabIndex].SetDrawState({$IF CompilerVersion >= 18.0}TDrawState.{$IFEND}dsActive, 0, {$IF CompilerVersion >= 18.0}TChromeTabs32EaseType.{$IFEND}ttNone, True);
  end;
end;

procedure TCustomChromeTabs32.LoadLookAndFeel(const Filename: String);
var
  FileStream: TFileStream;
begin
...
procedure TCustomChromeTabs32.LoadOptions(const Filename: String);
var
  FileStream: TFileStream;
begin
  FileStream := TFileStream.Create(Filename, fmOpenRead);
...
function TCustomChromeTabs32.LookAndFeelToCode: String;
var
  TabsLookAndFeel: TTabsLookAndFeel;
begin
  TabsLookAndFeel := TTabsLookAndFeel.Create(nil);
...
procedure TCustomChromeTabs32.LoadOptions(Stream: TStream);
var
  TabsOptions: TTabsOptions;
begin
  BeginUpdate;
...
procedure TCustomChromeTabs32.UpdateTabControlProperties;
var
  i: Integer;
begin
...
procedure TCustomChromeTabs32.SetActiveTab(const Value: TChromeTab);
begin
  if Value <> nil then
    FTabs.ActiveTab := Value;
end;

procedure TCustomChromeTabs32.SetActiveTabIndex(const Value: Integer);
begin
  if Value = -1 then
    Tabs.ActiveTab := nil
  else
...
procedure TCustomChromeTabs32.SetBiDiMode(Value: TBiDiMode);
begin
  inherited;
...
procedure TCustomChromeTabs32.SetLookAndFeel(Value: TChromeTabs32LookAndFeel);
begin
  FLookAndFeel.Assign(Value);
end;

function TCustomChromeTabs32.GetLookAndFeel: TChromeTabs32LookAndFeel;
begin
  Result := FLookAndFeel;
end;

procedure TCustomChromeTabs32.SetTabs(const Value: TChromeTabs32List);
begin
  FTabs.Assign(Value);
end;

procedure TCustomChromeTabs32.TabDragDrop(Sender: TObject; X, Y: Integer; DragTabObject: IDragTabObject; Cancelled: Boolean; var TabDropOptions: TTabDropOptions);
begin
...
procedure TCustomChromeTabs32.TabDragOver(Sender: TObject; X, Y: Integer;
...
procedure TCustomChromeTabs32.ShowTabDragForm(X, Y: Integer; FormVisible: Boolean);
var
  DragFormPoint: TPoint;
begin
  DragFormPoint := ClientToScreen(GR32.Point(X, Y));
...
procedure TCustomChromeTabs32.Redraw;
begin
  if FUpdateCount = 0 then
  begin
...
procedure TCustomChromeTabs32.WMContextMenu(var Message: TWMContextMenu);
var
  ScreenPoint: TPoint;
begin
  ScreenPoint := ClientToScreen(GR32.Point(FLastMouseX, FLastMouseY));
...
procedure TCustomChromeTabs32.WMERASEBKGND(var Message: TWMEraseBkgnd);
begin
  Message.Result := 1;
end;

procedure TCustomChromeTabs32.WMPaint(var Message: TWMPaint);
begin
  PaintHandler(Message);
end;

procedure TCustomChromeTabs32.WMWindowPosChanged(var Message: TWMWindowPosChanged);
begin
  inherited;
...
procedure TCustomChromeTabs32.WndProc(var Message: TMessage);
begin
  if (FDragTabObject <> nil) and
...
procedure TCustomChromeTabs32.DragCompleted(MouseX, MouseY: Integer; Cancelled: Boolean);
begin
...
function TCustomChromeTabs32.DraggingDockedTab: Boolean;
begin
...
function TCustomChromeTabs32.DraggingInOwnContainer: Boolean;
begin
...
function TCustomChromeTabs32.ActiveTabVisible: Boolean;
begin
...
// TODO      TabCanvas := TCanvas32.Create(FCanvasBmp.Canvas.Handle);
// TODO      BackgroundCanvas := TCanvas32.Create(FBackgroundBmp.Canvas.Handle);
      try
...
// TODO         DrawLine(Pen, 0, TabContainerRect.Bottom - 1, CorrectedClientWidth, TabContainerRect.Bottom - 1);
            end;
(* TODO
          toBottom:
            TabCanvas.DrawLine(Pen, 0, TabContainerRect.Top, CorrectedClientWidth, TabContainerRect.Top);
*)
        end;
...
function TCustomChromeTabs32.ControlRect: TRect;
begin
...
procedure TCustomChromeTabs32.SetDefaultLookAndFeel;
begin
  BeginUpdate;
  try
...
function FindChromeTabs32ControlAt(X, Y: Integer; var ChromeTabs32: TCustomChromeTabs32): Boolean;
var
  H: THandle;
  WinControl: TWinControl;
begin
  H:= WindowFromPoint(GR32.Point(X, Y));

  WinControl := FindControl(H);

  Result := WinControl is TCustomChromeTabs32;

  if Result then
    ChromeTabs32 := TCustomChromeTabs32(WinControl)
  else
    ChromeTabs32 := nil;
end;
...
begin
  ...
  begin
    if i = 0 then
      FindChromeTabs32ControlAt(FPoint.X, FPoint.Y, FChromeTabs32)
    else
    begin
      if (FindChromeTabs32ControlAt(FPoint.X - i, FPoint.Y - i, FChromeTabs32)) or
         (FindChromeTabs32ControlAt(FPoint.X + i, FPoint.Y - i, FChromeTabs32)) or
         (FindChromeTabs32ControlAt(FPoint.X + i, FPoint.Y + i, FChromeTabs32)) or
         (FindChromeTabs32ControlAt(FPoint.X - i, FPoint.Y + i, FChromeTabs32)) then
        Break;
    end;
